...
-- Es útil usar SELECT * en entornos de desarrollo/exploración para entender la estructura de la tabla.
-- NO se recomienda en producción por impacto en rendimiento y mantenimiento.
